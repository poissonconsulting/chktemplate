...
for a user. Use the
[`template_human()`](https://poissonconsulting.github.io/chktemplate/reference/template_human.md)
function to convert the template into a human readable form.
...
Pass data and the template to
[`check_data_format()`](https://poissonconsulting.github.io/chktemplate/reference/check_data_format.md)
to ensure the data follows all the rules and requirements of the
template. It can check whether all columns are supplied, the type of the
column, the range of values, the primary key, uniqueness of the column,
...
- join1: place parent table name in the variable(s) that should be the
  ...
  - Check
    [`chktemplate::demo_template_count`](https://poissonconsulting.github.io/chktemplate/reference/demo_template_count.md)
    template for an example of a table with multiple join rows.
